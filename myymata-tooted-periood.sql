...
AND (TV_MYYTY <= '2018-1-1' OR TV_MYYTY IS NULL) AND TV_SAAPUU <= '2018-1-1'
AND TV_VARASTOSSA > 0 
AND TP_ALEKOODI NOT IN (1051, 1151, 1351, 1451, 1456, 1461, 1471) AND TP_TUOTEKOODI NOT LIKE '%RUNKO'    -- KORPUSED
AND TP_TUOTEKOODI != 'ROLLUP-EG' AND TP_TUOTEKOODI != '75040' AND TP_TUOTEKOODI != 'ADS-01'    -- STENDID
